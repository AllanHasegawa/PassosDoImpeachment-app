...
import com.hasegawa.diapp.domain.entities.GCMMessageType.Companion
    ...
    fun getResolver() = object : DefaultGetResolver<GCMMessageEntity>() {
        override fun mapFromCursor(c: Cursor): GCMMessageEntity {
            ...
            return GCMMessageEntity(
                    ...
                    syncsId,
                    Companion.fromValue(c.getIntByColumnName(GCMMessagesContract.COL_TYPE)),
...
fun GCMMessageEntity.toContentValues(): ContentValues {
    ...
    c.put(GCMMessagesContract.COL_TYPE, this.type.value)
